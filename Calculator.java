...
public class Calculator implements ActionListener{
    ...
    public Calculator()
    {
        ...
        resultHolder = new JTextField();
        resultHolder.setHorizontalAlignment(JTextField.RIGHT);
        resultHolder.setEditable(false);
        
        guiFrame.add(resultHolder, BorderLayout.NORTH);
        ...
        equalsButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent event)
            {
                ...
                {
                    int number = Integer.parseInt(resultHolder.getText()); 
                    if (calcOperation == 1)
                    {
                        int calculate = currentCalc  + number;
                        resultHolder.setText(Integer.toString(calculate));
                    }
    ...
    private class OperatorAction implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent event)
        {
            currentCalc = Integer.parseInt(resultHolder.getText()); 
